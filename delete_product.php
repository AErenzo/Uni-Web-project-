				...
				<?php
					...
					{ // If connection error
						...
						if ($result == false) {
							...
							echo "<script type='text/javascript'>alert('deleteing record failed')</script>";
						}	
						else
						{
							echo "<script type='text/javascript'>alert('Record has been successfully deleted')</script>";
